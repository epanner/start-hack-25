...
detailed_prompt = client_prompt + "\n\n" + \
    "Based on the above information, what are the top 3 actions a wealth manager should consider? " \
    "List each action along with a brief explanation."

print(perplexity_chat(detailed_prompt))
